...
export function SocialProof() {
  ...
  const certifications = [
    ...
    { name: 'Personalized Support', badge: 'Nutrition-focused guidance' }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Explore nutrition-focused support built around your goals, routines, and the questions you want to discuss.
          </p>
        </div>
        ...
        <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-8 lg:p-12 border border-gray-200/50 shadow-xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Credentials and approaches shared by Empowered Wellness with Inna</p>
          </div>
        ...
        <div className="mt-12 text-center">
          <div className="flex flex-wrap justify-center items-center gap-8 text-gray-500">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium">Thoughtful Support</span>
            </div>
            <div className="flex items-center gap-2">
              <svg className="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
