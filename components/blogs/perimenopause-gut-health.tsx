...
export default function PerimenopauseGutHealth() {
  return (
    <>
      <Head>
        <title>
          Perimenopause and Gut Health: What Most Doctors Overlook | Empowered
          Wellness with Inna
        </title>
        <meta
          name="description"
          content="Explore the vital connection between perimenopause, estrogen, and your gut microbiome. Learn how gut imbalances fuel symptoms and discover empowering steps to support your health."
        />
      </Head>
          ...
          <article>
            ...
            <div className="prose prose-lg max-w-none mb-8">
              <p className="text-lg leading-relaxed text-gray-700">
                As you enter perimenopause, you might notice new digestive
                symptoms — bloating, food sensitivities or changes in bowel
                habits. These are often shrugged off as "just part of getting
                older," but emerging research suggests they are intimately tied
                to your gut microbiome and hormonal shifts.
              </p>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700 italic">
                    Studies of postmenopausal women have found significantly
                    altered gut microbiota and metabolite profiles compared with
                    non-menopausal controls, particularly in amino acid and
                    lipid pathways that affect overall health and symptom
                    severity.
                  </p>
                </div>
              </div>
            ...
            <section id="hormones-gut" className="mb-12">
              ...
              <p className="prose prose-lg max-w-none mb-6">
                During perimenopause and menopause, declining oestrogen levels
                influence gut microbial diversity and function. Studies of
                postmenopausal women have found altered gut microbiota and
                metabolite profiles compared with non-menopausal controls,
                particularly in amino acid and lipid pathways.
              </p>
              <p className="prose prose-lg max-w-none mb-6">
                Menopause is associated with decreased{" "}
                <strong>Bifidobacterium</strong> and{" "}
                <strong>Lactobacillus</strong> (beneficial microbes) and
                increased potentially pro-inflammatory genera. This shift isn't
                just coincidental — it's a direct result of hormonal changes
              ...
              <div className="bg-[#53A107]/10 border-l-4 border-[#53A107] p-6 mb-6 rounded-r-lg">
                ...
                <p className="text-gray-700">
                  The gut microbiome can actually influence estrogen levels
                  through the "estrobolome" — specific bacterial genes that
                  produce enzymes capable of metabolizing estrogens. This
                  creates a bidirectional relationship where hormones affect gut
                  health, and gut health affects hormone balance.
                </p>
              </div>
            </section>
            ...
            <div className="bg-gradient-to-br from-[#41ab5d] to-[#183B10] text-white rounded-2xl p-8 mb-12 text-center shadow-xl">
              <div className="max-w-2xl mx-auto">
                <h3 className="text-2xl md:text-3xl font-bold mb-4">
                  Ready to Support Your Gut During Perimenopause?
                </h3>
                <p className="text-lg mb-6 opacity-90">
                  Book a complimentary 15-minute Wellness Clarity Call to learn
                  how functional testing and personalized nutrition can help
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Inna specializes in women's health and hormonal balance,
                    helping clients navigate perimenopause and menopause through
                    root-cause functional nutrition. Her approach combines
                    advanced lab testing with compassionate, personalized care.
                  </p>
                </div>
              </div>
            </aside>
