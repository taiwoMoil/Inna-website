...
export default function RootCauseNutrition() {
  return (
    <>
      <Head>
        <title>Root-Cause Nutrition vs. Quick Fixes: Why Personalization Matters | Empowered Wellness with Inna</title>
          ...
          <article>
            ...
            <div className="bg-gradient-to-br from-[#41ab5d] to-[#183B10] text-white rounded-2xl p-8 mb-12 text-center shadow-xl">
              <div className="max-w-2xl mx-auto">
                ...
                <p className="text-lg mb-6 opacity-90">Book a complimentary 15-minute Wellness Clarity Call to learn how functional testing and root-cause nutrition can transform your health journey.</p>
