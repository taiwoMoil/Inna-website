...
export default function CorporateWellness() {
  return (
    <>
      <Head>
        <title>
          Corporate Wellness Spotlight: How Gut Health Programs Boost
          Productivity and Reduce Costs | Empowered Wellness with Inna
        </title>
        <meta
          name="description"
          content="Discover how digestive disorders impact workplace productivity and costs, plus evidence-based strategies for implementing gut health programs in corporate settings."
        />
      </Head>
          ...
          <div className="max-w-4xl mx-auto px-4 py-4">
            <div className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <span className="text-gray-900">
                Corporate Wellness: Gut Health Programs
              </span>
            </div>
          </div>
        </nav>
        ...
        <article className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <aside className="bg-gray-50 rounded-lg p-6 mb-8 border border-gray-200">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="#cost" className="text-[#41ab5d] hover:underline">
                  The Hidden Cost of Poor Gut Health
                </a>
              </li>
              <li>
                <a href="#issues" className="text-[#41ab5d] hover:underline">
                  Common Digestive Issues Affecting Workforce
                </a>
              </li>
              <li>
                <a
                ...
                >
                  The Gut-Brain Connection & Performance
                </a>
              </li>
              <li>
                <a
          ...
          <div className="prose prose-lg max-w-none">
            <div className="bg-blue-50 border-l-4 border-blue-400 p-6 mb-8 rounded-r-lg">
              <p className="text-blue-800 font-medium">
                <strong>Business Impact:</strong> Companies with comprehensive
                gut health programs see a 25% reduction in sick days, 30%
                improvement in employee satisfaction, and an average ROI of
                $3.27 for every dollar invested in digestive wellness
                initiatives.
              </p>
            </div>

            <p className="text-xl text-gray-700 leading-relaxed mb-8">
              While most corporate wellness programs focus on fitness challenges
              and mental health resources, forward-thinking companies are
              discovering that gut health might be the missing piece in their
              employee wellness puzzle. With digestive disorders affecting up to
              70% of the workforce and costing billions in lost productivity,
              it's time to give gut health the attention it deserves.
            </p>
            ...
            <p className="mb-6">
              Digestive issues don't just affect employees at home—they follow
              them to work, impacting everything from concentration and energy
              levels to absenteeism and healthcare costs.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="bg-gray-50 p-6 rounded-xl">
                ...
                <p className="text-gray-700 text-sm mb-3">
                  Affects 10-15% of adults globally, causing unpredictable
                  symptoms that can disrupt work schedules.
                </p>
                <div className="text-xs text-gray-600">
                  <strong>Impact:</strong> 2.5x more sick days, reduced focus
                  during flare-ups
                </div>
              </div>
              <div className="bg-gray-50 p-6 rounded-xl">
                ...
                <p className="text-gray-700 text-sm mb-3">
                  Affects 20% of the population, often worsened by workplace
                  stress and irregular eating patterns.
                </p>
                <div className="text-xs text-gray-600">
                  <strong>Impact:</strong> Sleep disruption, afternoon energy
                  crashes
                </div>
              </div>
              <div className="bg-gray-50 p-6 rounded-xl">
                ...
                <p className="text-gray-700 text-sm mb-3">
                  Often undiagnosed, causing brain fog, fatigue, and digestive
                  discomfort after meals.
                </p>
                <div className="text-xs text-gray-600">
                  <strong>Impact:</strong> Post-lunch productivity dips,
            ...
            <p className="mb-6">
              The gut produces 90% of the body's serotonin and houses 70% of the
              immune system. When gut health is compromised, it directly
              affects:
            </p>
            ...
            <div className="bg-yellow-50 p-8 rounded-xl mb-8">
              ...
              <p className="text-yellow-800 mb-4">
                Mid-sized software company (500 employees) implemented a
                comprehensive gut health program after noticing high rates of
                afternoon fatigue and frequent sick days.
              </p>
            ...
            <h2 className="text-3xl font-bold text-[#183B10] mt-12 mb-6">
            ...
            <p className="mb-6">
              As we move toward a more holistic understanding of employee
              health, gut health programs represent the next evolution in
              corporate wellness. Companies that invest in comprehensive
              digestive health initiatives today will see the benefits in
              improved productivity, reduced healthcare costs, and higher
              employee satisfaction for years to come.
            </p>
          </div>
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <article className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                <span className="bg-[#E88074]/20 text-[#E88074] px-2 py-1 rounded text-xs font-medium">
                  Women's Health
                </span>
                <h4 className="text-xl font-semibold text-[#183B10] mt-2 mb-2">
                ...
                <a
                  href="/blogs/healthcare-fails-women"
                  className="text-[#41ab5d] hover:underline text-sm"
                >
                  Read Article →
                </a>
          ...
          <div className="bg-gradient-to-br from-[#41ab5d] to-[#183B10] text-white rounded-2xl p-8 mb-12 text-center shadow-xl">
            <div className="max-w-2xl mx-auto">
              ...
              <p className="text-lg mb-6 opacity-90">
                Let's discuss how a customized gut health program can benefit
                your organization. I work with companies of all sizes to
                implement evidence-based wellness strategies that deliver real
                results.
              </p>
              <Link
